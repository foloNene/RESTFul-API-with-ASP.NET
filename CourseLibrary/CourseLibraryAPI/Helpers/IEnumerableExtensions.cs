...
namespace CourseLibraryAPI.Helpers
{
    public static class IEnumerableExtensions
    {
            ...
            string fields)
        {
            ...
            // create a list with PropertyInfo objectd on TSource. Reflection is 
            // expansive, so rather than doing it for each object in the list, we do
            //it once snd reuse the results. After all, part of the reflection is on the 
            ...
            {
                //the fireld are sepearated by ",", so we split it.
                ...
                foreach(var field in fieldsAfterSplit)
                {
                    ...
                    {
                        throw new Exception($"Property {propertyName} was't found on" +
                            $"{ typeof(TSource)}");
                    }
            ...
            foreach(TSource sourceObejct in source)
            {
               ...
               foreach(var propertyInfo in propertyInfoList)
                {
                    ...
                    var propertyValue = propertyInfo.GetValue(sourceObejct);
